 ...
 */
public class newsuser extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private static String url_list   =  "https://ristahandani75.000webhostapp.com/berita.php?offset=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(newsuser.this, detailnewsuser.class);
        ...
        adapter = new NewsAdapter(newsuser.this, newsList);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(newsuser.this, MenuActivity.class);
        intent.putExtra(TAG_ID, iduser);
        intent.putExtra(TAG_USERNAME, username);
        startActivity(intent);
    }
