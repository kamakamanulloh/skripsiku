...
public class fotokomen extends AppCompatActivity {
    Intent intent;
    Uri fileUri;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fotokomen);
        ...
        txtkomen=(EditText)findViewById(R.id.txt_komen);
        kirim=(Button)findViewById(R.id.btnsend);
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == REQUEST_CAMERA) {
                ...
                try {
                    ...
                    bitmap = MediaStore.Images.Media.getBitmap(fotokomen.this.getContentResolver(), data.getData());
                    setToImageView(getResizedBitmap(bitmap, max_resolution_image));
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    private void kosong() {
        ...
        Intent intent = new Intent(fotokomen.this, lvkomentar.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UPLOAD_URL,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success == 1) {
                                ...
                                Toast.makeText(fotokomen.this, jObj.getString(TAG_MESSAGE), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        //menampilkan toast
                        Toast.makeText(fotokomen.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put(KEY_KOMENTAR,koment);
                params.put(KEY_NAMAkomen,username);
