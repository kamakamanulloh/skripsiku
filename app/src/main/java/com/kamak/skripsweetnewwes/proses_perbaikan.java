...
public class proses_perbaikan extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    private static String url_list   =  Server.URL +"prosesuser.php?offset=";
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.back:
                    ...
                    Intent intent=new Intent(proses_perbaikan.this,home.class);
                ...
                case R.id.home:
                    ...
                    intent=new Intent(proses_perbaikan.this,home.class);
                    intent.putExtra(TAG_ID, iduser);
                    intent.putExtra(TAG_USERNAME, username);
                    intent.putExtra(TAG_ALAMAT, alamat);
                    intent.putExtra(TAG_NOHP, nohp);
                    ...
                    break;
                case R.id.post:
                    intent=new Intent(proses_perbaikan.this,foto.class);
                    intent.putExtra(TAG_ID, iduser);
                    intent.putExtra(TAG_USERNAME, username);
                    intent.putExtra(TAG_ALAMAT, alamat);
                    intent.putExtra(TAG_NOHP, nohp);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent intent = new Intent(proses_perbaikan.this, DetailNews.class);
                intent.putExtra(TAG_ID, iduser);
                intent.putExtra(TAG_USERNAME, username);
        ...
        adapter = new NewsAdapter(proses_perbaikan.this, newsList);
